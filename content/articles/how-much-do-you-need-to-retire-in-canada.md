...
description: There's no single magic number. Here's how to work out your own Canadian retirement target using spending, CPP, OAS and a safe withdrawal rate.
date: 2026-06-30
tags: [Planning, Basics]
related: [the-order-to-draw-down-your-accounts, seven-ways-to-cut-tax-in-retirement]
calculator: { slug: canadian-retirement-calculator, label: Model your number, tab: scenarios }
faqs:
  - q: Is $1 million enough to retire in Canada?
    a: For many Canadians, yes. Because CPP and OAS provide guaranteed, inflation-indexed income, a $1M portfolio drawn at 4% (about $40,000/year) plus government benefits often supports a comfortable middle-class retirement — but it depends on your spending, province and when you start CPP.
  - q: What is a safe withdrawal rate?
    a: A safe withdrawal rate is the percentage of your portfolio you can take each year with low risk of running out. The classic figure is 4%, but 3–3.5% is more conservative for early retirees with a long horizon.
---
